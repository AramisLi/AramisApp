...
Java_hello_com_aramis_opengl_december_Test_test(JNIEnv *env, jclass type) {


    string returnValue = "我是大帅哥";
...
Java_hello_com_aramis_opengl_december_face_FaceTrack_native_1create(JNIEnv *env, jobject instance, jstring model_,
                                                      jstring seeta_) {
...
Java_hello_com_aramis_opengl_december_face_FaceTrack_native_1start(JNIEnv *env, jobject instance, jlong self) {
...
extern "C"
JNIEXPORT void JNICALL
Java_hello_com_aramis_opengl_december_face_FaceTrack_native_1stop(JNIEnv *env, jobject instance, jlong self) {
...
Java_hello_com_aramis_opengl_december_face_FaceTrack_native_1detector(JNIEnv *env, jobject instance, jlong self,
...
//    int ret = rects.size();
//    if (ret) {
//        jclass clazz = env->FindClass("hello/com/aramis/opengl/december/face/Face");
