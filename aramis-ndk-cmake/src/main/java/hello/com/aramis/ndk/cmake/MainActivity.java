package hello.com.aramis.ndk.cmake;
...
//    implements View.OnTouchListener, Runnable
...
//        LinearLayout.LayoutParams lpLayout = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT, 1.0f);
//
